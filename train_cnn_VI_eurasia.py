...
min_max = pd.read_csv("/explore/nobackup/people/spotter5/cnn_mapping/Russia/modis_glob_norm.csv").reset_index(drop = True)
...
training_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/Russia/modis_16_training_files.csv')['Files'].tolist()
validation_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/Russia/modis_16_validation_files.csv')['Files'].tolist()
testing_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/Russia/modis_16_testing_files.csv')['Files'].tolist()
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/anna_modis_16_global_norm",
#     verbose=1,
...
#save final model
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/annas_modis_16_global_norm.tf")
...
#save to csv
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/Russia/anna_16_global_norm.csv")
