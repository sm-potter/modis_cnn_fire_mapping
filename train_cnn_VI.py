...
training_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_nbac_32_training_files.csv')['Files'].tolist()
validation_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_nbac_32_validation_files.csv')['Files'].tolist()
testing_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_nbac_32_testing_files.csv')['Files'].tolist()

#get all pathways to nbac
training_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_mtbs_32_training_files.csv')['Files'].tolist()
validation_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_mtbs_32_validation_files.csv')['Files'].tolist()
testing_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_mtbs_32_testing_files.csv')['Files'].tolist()
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_modis_32_global_norm",
#     verbose=1,
...
#save final model
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/nbac_mtbs_modis_32_global_norm.tf")
...
#save to csv
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_mtbs_modis_32_global_norm.csv")
